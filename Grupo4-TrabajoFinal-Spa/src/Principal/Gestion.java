...
public class Gestion extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        ImageIcon icon = new ImageIcon(getClass().getResource("/Imagenes/FondoEscri.jpeg"));
    ...
    private void jMenuItem8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem8ActionPerformed
        ...
        Escritorio.removeAll();
        Escritorio.repaint();
        GestionarInstalaciones gi = new GestionarInstalaciones();
        gi.setVisible(true);
        Escritorio.add(gi);
    ...
    private void jMenuItem9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem9ActionPerformed
        ...
        Escritorio.removeAll();
        Escritorio.repaint();
        GestionarMasajistas gm = new GestionarMasajistas();
        gm.setVisible(true);
        Escritorio.add(gm);
    ...
    private void jMenuItem10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem10ActionPerformed
        ...
        Escritorio.removeAll();
        Escritorio.repaint();
        TratamientosMasSesionados tms = new TratamientosMasSesionados();
        tms.setVisible(true);
        Escritorio.add(tms);
        Escritorio.moveToFront(tms);
